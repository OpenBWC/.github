...
* **Core Logic & Frameworks:** Components like our pipeline will be licensed under the [AGPL](https://en.wikipedia.org/wiki/GNU_Affero_General_Public_License), prioritizing maximum permissive reuse for the research community.
